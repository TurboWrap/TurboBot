...
# Upstream GUI
if you just want to play with the upstream TurboWrap GUI, go to: [Turbowrap-gui](https://github.com/TurboWrap/gui). It already contains powerful tools and plugins right out of the box. Plus an extra packager for .wrap projects.
